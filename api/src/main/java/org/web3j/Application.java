...
//@ImportResource({"classpath*:application.properties"}) //加入dubbo的配置文件
...
//
//            tokenERC20.transfer(toAccount,new BigInteger("98888888888888888888")).send();
//            balanceTo = tokenERC20.balanceOf(toAccount).send();
//            balanceFrom = tokenERC20.balanceOf(baseAccount).send();
...
//            tokenERC20.recycling(toAccount,  new BigInteger("96666666666666666666")).send();
//            balanceTo = tokenERC20.balanceOf(toAccount).send();
//            balanceFrom = tokenERC20.balanceOf(baseAccount).send();
